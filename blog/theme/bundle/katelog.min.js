...
(function() {
    ...
    ! function(e, t) { "function" == typeof define && define.amd ? define(function() { return t }) : "object" === ("undefined" == typeof exports ? "undefined" : y(exports)) ? module.exports = t : e.katelog = t }(window, function(e) {
        function f(e, t) { return !!e.className && e.className.match(new RegExp("(\\s|^)" + t + "(\\s|$)")) }
        ...
        function t(e) { for (var t, n = void 0, o = [], i = {}, a = { id: -1 }, l = null, r = void 0, c = 0; c < e.length; c++) r = "heading-" + c, i = { name: e[c].innerText || e[c].textContent, tagName: n = e[c].tagName, id: e[c].id = r, level: (t = n, t ? t.slice(1) : 0), parent: a }, l && (d(i.tagName) < d(l.tagName) ? i.parent = l : i.parent = s(i, l)), l = i, o.push(i); return o }

        function s(e, t) { for (var n = t.parent; n && d(e.tagName) >= d(n.tagName);) n = n.parent; return n || { id: -1 } }
        ...
        function n(e, t, n) { e && (e.attachEvent ? (e["e" + t + n] = n, e[t + n] = function() { e["e" + t + n](window.event) }, e.attachEvent("on" + t, e[t + n])) : e.addEventListener(t, n, !1)) }
        ...
        var p = Object.assign({}, { linkClass: "k-catelog-link", linkActiveClass: "k-catelog-link-active", supplyTop: 0, selector: ["h1", "h2", "h3", "h4", "h5", "h6"], active: null }, e),
        ...
        function m(e) { for (var t = e.offsetTop; e = e.offsetParent;) t += e.offsetTop; return t } h.type = "text/css", h.styleSheet ? h.styleSheet.cssText = c : h.innerHTML = c, document.getElementsByTagName("head")[0].appendChild(h), n(g, "click", function(e) {
            ...
            if (!l) {
                for (var t = (document.documentElement.scrollTop || document.body.scrollTop) + p.supplyTop, n = null, o = i.length - 1; 0 <= o; o--)
                    if (m(i[o]) <= t) { n = i[o]; break } v(n ? n.id : null)
            }
            l = !1
        }), this.rebuild = function() {
            var e = t(i = o.querySelectorAll(p.selector.join()));
            g.innerHTML = r(e, { id: -1 })
        }
    });
})()